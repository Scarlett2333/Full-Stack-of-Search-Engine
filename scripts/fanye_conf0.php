...
<?php
    ...
    $result = mysqli_query($link, "SELECT PaperID,Title,PaperPublishYear from papers where ConferenceID='$conf_id' order by PaperPublishYear asc");
    ...
    if ($result) {
        ...
        if ($total<=10*page){
            ...
            if($page==2){ echo "<br \>";
                ...
                $char="Last Page";
                $page=$page-2;
                echo "<a href=\"/fanye_conf0.php?conf_id=$conf_id&total=$total&page=$page\">$char </a>";
            }
            //echo "<br \>";
            $char="Next Page";
            $page=$page+2;
            echo "<a href=\"/fanye_conf0.php?conf_id=$conf_id&total=$total&times=$times&page=$page\">$char </a>";
