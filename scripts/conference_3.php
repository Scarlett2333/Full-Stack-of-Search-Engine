...
<body>
	...
	<?php
		...
		$result = mysqli_query($link, "SELECT PaperID,Title,PaperPublishYear from papers where ConferenceID='$conf_id' order by Title DESC");
		...
		<style>
				...
				Ranking:
				<div class="dropdown">
				  <button class="dropbtn">Order by Title(DESC)</button>
		...
		if ($result) {
			...
			echo " <a href='conference.php?page={$maxpage}{$url}'>尾页</a> ";
		 	...
		 	if ($total<=10){
                ...
                echo "<br \>";
                $char="Next Page";
                echo "<a href=\"/fanye_conf3.php?conf_id=$conf_id&total=$total&times=$times&page=$page\">$char </a>";
                $char="Back to Search";
                echo "<a href=\"/index.php?\">$char </a>";
                echo "<br \>";
                echo "<br \>";
