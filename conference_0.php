...
Ranking:
    <div class="dropdown">
    <button class="dropbtn">Order by PaperPublishYear(ASC)</button>
    ...
    <div id="chart" style="float:left;width:100%;height:400px;"></div>
    ...
    var options = {
        title : {
        text: 'Publication volume trend chart',
    ...
    toolbox: {
        ...
        data: <?php echo json_encode($year_number); ?>  ,
            markPoint : {
                data : [
                {type : 'max', name: 'max'},
                {type : 'min', name: 'min'}
